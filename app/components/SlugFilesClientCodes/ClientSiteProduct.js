...
export default function ClientSiteProduct({ product,excludeProduct }) {
  ...
  return (
    <div className="w-full md:py-20">
      ...
      <Wrapper>
        <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-y-[100px]">
          {/* left column start */}
              ...
              {p.original_price && (
                <>
                  ...
                  <p className="ml-auto text-base font-medium text-green-500">
                    {getDiscountedPriceProduct(p.original_price, p.price)}%
                    off
                  </p>
                </>
              )}
